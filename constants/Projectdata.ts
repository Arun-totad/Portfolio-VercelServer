const cards = [
    {
      src: '/projectimages/license.jpeg', // Ensure you use unique images for each project
      title: 'Twitter Sentiment Analysis',
      description: 'This project involves using Logistic Regression model, analysed 1.6 million twitter statement datasets with accuracy of 84%, Designed and implemented a Python Machine Learning Model to evaluate statement with sentiment analysis.',
      skills: ['BigData', 'Python', 'NumPy', 'API Integration'],
      githubLink: 'https://github.com/Arun-totad/Twitter-Sentiment-Analysis-Masters',
    },
    {
      src: '/projectimages/rag.jpeg', // Update with unique project image
      title: 'Retrieval Augmented Generation Chatbot',
      description: 'This project involves analyzing PDFs and images, allowing users to ask content-based questions using Chainlit, LangChain, LLAMA, and OpenAI.',
      skills: ['ChainLit', 'LangChain', 'LLAMA', 'OpenAI', 'Python', 'NLP'],      
      githubLink: 'https://github.com/Arun-totad/Meta-Evaluation-Chatbot-Masters',
    },
    {
      src: '/projectimages/facemask.jpeg', // Update with unique project image
      title: ' Sarcasm Detection Using Natural Language Processing',
      description: 'A face recognition system with eye-blink detection as part of an Artificial Intelligence Masters Project,',
      skills: ['OpenCV', 'Python', 'scikit-learn', 'Fisher-face'],      
      githubLink: 'https://github.com/Arun-totad/Face-Recognition-with-Eye-Blink-Detection-Masters',
    },
    // {
    //   "src": "/projectimages/claimit.jpg",
    ...
    // },    
    // {
    //   src: '/projectimages/facemask.jpeg', // Ensure you use unique images for each project
    ...
    // },    
    // {
    //   src: '/projectimages/hatespeech.png', // Ensure you use unique images for each project
    ...
    // },
    // {
    //   src: '/projectimages/searchengine.jpeg', // Ensure you use unique images for each project
    ...
    // },    
    // {
    //   src: '/projectimages/lex.jpeg', // Ensure you use unique images for each project
    ...
    // },
    // {
    //   "src": "/projectimages/sysadmin.webp",
    ...
    // },
    // {
    //   src: "/projectimages/linkedlist.webp",
    ...
    // },
    // {
    //   "src": "/projectimages/supplychain.jpeg",
